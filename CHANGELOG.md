...
* State import: allow replication factor and allocations overwrite | [ipfs-cluster/ipfs-cluster#1508](https://github.com/lubanproj/ipfs-cluster/issues/1508)
...
* Dependency upgrades | [ipfs-cluster/ipfs-cluster#1451](https://github.com/lubanproj/ipfs-cluster/issues/1451)
...
* Better badger defaults for less memory usage | [ipfs-cluster/ipfs-cluster#1027](https://github.com/lubanproj/ipfs-cluster/issues/1027)
...
* cluster: `health/graph` improvements | [ipfs-cluster/ipfs-cluster#800](https://github.com/lubanproj/ipfs-cluster/issues/800) | [ipfs-cluster/ipfs-cluster#925](https://github.com/lubanproj/ipfs-cluster/issues/925) | [ipfs-cluster/ipfs-cluster#954](https://github.com/lubanproj/ipfs-cluster/issues/954)
...
* configs: support a `follower_mode` option | [ipfs-cluster/ipfs-cluster#803](https://github.com/lubanproj/ipfs-cluster/issues/803) | [ipfs-cluster/ipfs-cluster#864](https://github.com/lubanproj/ipfs-cluster/issues/864)
...
* ctl: support adding pin metadata | [ipfs-cluster/ipfs-cluster#670](https://github.com/lubanproj/ipfs-cluster/issues/670) | [ipfs-cluster/ipfs-cluster#891](https://github.com/lubanproj/ipfs-cluster/issues/891)
...
##### Bug fixes
  ...
  * Fix docker compose tests | [ipfs-cluster/ipfs-cluster#696](https://github.com/lubanproj/ipfs-cluster/issues/696)
  * Hide `ipfsproxy.extract_headers_ttl` and `ipfsproxy.extract_headers_path` options by default | [ipfs-cluster/ipfs-cluster#699](https://github.com/lubanproj/ipfs-cluster/issues/699)
...
##### Features
  ...
  * Integrate [OpenCensus](https://opencensus.io) tracing and metrics into IPFS Cluster codebase | [ipfs-cluster/ipfs-cluster#486](https://github.com/lubanproj/ipfs-cluster/issues/486) | [ipfs-cluster/ipfs-cluster#658](https://github.com/lubanproj/ipfs-cluster/issues/658) | [ipfs-cluster/ipfs-cluster#659](https://github.com/lubanproj/ipfs-cluster/issues/659) | [ipfs-cluster/ipfs-cluster#676](https://github.com/lubanproj/ipfs-cluster/issues/676) | [ipfs-cluster/ipfs-cluster#671](https://github.com/lubanproj/ipfs-cluster/issues/671) | [ipfs-cluster/ipfs-cluster#674](https://github.com/lubanproj/ipfs-cluster/issues/674)
...
##### Deprecated
  ...
  * The snap distribution of IPFS Cluster has been removed | [ipfs-cluster/ipfs-cluster#593](https://github.com/lubanproj/ipfs-cluster/issues/593) | [ipfs-cluster/ipfs-cluster#649](https://github.com/lubanproj/ipfs-cluster/issues/649).
...
##### Features
  ...
  * IPFS Proxy extraction to its own `API` component: `ipfsproxy` | [ipfs-cluster/ipfs-cluster#453](https://github.com/lubanproj/ipfs-cluster/issues/453) | [ipfs-cluster/ipfs-cluster#576](https://github.com/lubanproj/ipfs-cluster/issues/576) | [ipfs-cluster/ipfs-cluster#616](https://github.com/lubanproj/ipfs-cluster/issues/616) | [ipfs-cluster/ipfs-cluster#617](https://github.com/lubanproj/ipfs-cluster/issues/617)
  * Add full CORS handling to `restapi` | [ipfs-cluster/ipfs-cluster#639](https://github.com/lubanproj/ipfs-cluster/issues/639) | [ipfs-cluster/ipfs-cluster#640](https://github.com/lubanproj/ipfs-cluster/issues/640)
  * `restapi` configuration section entries can be overridden from environment variables | [ipfs-cluster/ipfs-cluster#609](https://github.com/lubanproj/ipfs-cluster/issues/609)
  * Update to `go-ipfs-files` 2.0 | [ipfs-cluster/ipfs-cluster#613](https://github.com/lubanproj/ipfs-cluster/issues/613)
  * Tests for the `/monitor/metrics` endpoint | [ipfs-cluster/ipfs-cluster#587](https://github.com/lubanproj/ipfs-cluster/issues/587) | [ipfs-cluster/ipfs-cluster#622](https://github.com/lubanproj/ipfs-cluster/issues/622)
  * Support `stream-channels=fase` query parameter in `/add` | [ipfs-cluster/ipfs-cluster#632](https://github.com/lubanproj/ipfs-cluster/issues/632) | [ipfs-cluster/ipfs-cluster#633](https://github.com/lubanproj/ipfs-cluster/issues/633)
  * Support server side `/pins` filtering  | [ipfs-cluster/ipfs-cluster#445](https://github.com/lubanproj/ipfs-cluster/issues/445) | [ipfs-cluster/ipfs-cluster#478](https://github.com/lubanproj/ipfs-cluster/issues/478) | [ipfs-cluster/ipfs-cluster#627](https://github.com/lubanproj/ipfs-cluster/issues/627)
  * `ipfs-cluster-ctl add --no-stream` option | [ipfs-cluster/ipfs-cluster#632](https://github.com/lubanproj/ipfs-cluster/issues/632) | [ipfs-cluster/ipfs-cluster#637](https://github.com/lubanproj/ipfs-cluster/issues/637)
  * Upgrade dependencies and libp2p to version 6.0.29 | [ipfs-cluster/ipfs-cluster#624](https://github.com/lubanproj/ipfs-cluster/issues/624)

##### Bug fixes

 * Respect IPFS daemon response headers on non-proxied calls | [ipfs-cluster/ipfs-cluster#382](https://github.com/lubanproj/ipfs-cluster/issues/382) | [ipfs-cluster/ipfs-cluster#623](https://github.com/lubanproj/ipfs-cluster/issues/623) | [ipfs-cluster/ipfs-cluster#638](https://github.com/lubanproj/ipfs-cluster/issues/638)
 * Fix `ipfs-cluster-ctl` usage with HTTPs and `/dns*` hostnames | [ipfs-cluster/ipfs-cluster#626](https://github.com/lubanproj/ipfs-cluster/issues/626)
 * Minor fixes in sharness | [ipfs-cluster/ipfs-cluster#641](https://github.com/lubanproj/ipfs-cluster/issues/641) | [ipfs-cluster/ipfs-cluster#643](https://github.com/lubanproj/ipfs-cluster/issues/643)
 * Fix error handling when parsing the configuration | [ipfs-cluster/ipfs-cluster#642](https://github.com/lubanproj/ipfs-cluster/issues/642)
...
##### Features
  ...
  * Clean (rotate) the state when running `init` | [ipfs-cluster/ipfs-cluster#532](https://github.com/lubanproj/ipfs-cluster/issues/532) | [ipfs-cluster/ipfs-cluster#553](https://github.com/lubanproj/ipfs-cluster/issues/553)
  * Configurable REST API headers and CORS defaults | [ipfs-cluster/ipfs-cluster#578](https://github.com/lubanproj/ipfs-cluster/issues/578)
  * Upgrade libp2p and other deps | [ipfs-cluster/ipfs-cluster#580](https://github.com/lubanproj/ipfs-cluster/issues/580) | [ipfs-cluster/ipfs-cluster#590](https://github.com/lubanproj/ipfs-cluster/issues/590) | [ipfs-cluster/ipfs-cluster#592](https://github.com/lubanproj/ipfs-cluster/issues/592) | [ipfs-cluster/ipfs-cluster#598](https://github.com/lubanproj/ipfs-cluster/issues/598) | [ipfs-cluster/ipfs-cluster#599](https://github.com/lubanproj/ipfs-cluster/issues/599)
  * Use `gossipsub` to broadcast metrics | [ipfs-cluster/ipfs-cluster#573](https://github.com/lubanproj/ipfs-cluster/issues/573)
  * Download gx and gx-go from IPFS preferentially | [ipfs-cluster/ipfs-cluster#577](https://github.com/lubanproj/ipfs-cluster/issues/577) | [ipfs-cluster/ipfs-cluster#581](https://github.com/lubanproj/ipfs-cluster/issues/581)
  * Expose peer metrics in the API + ctl commands | [ipfs-cluster/ipfs-cluster#449](https://github.com/lubanproj/ipfs-cluster/issues/449) | [ipfs-cluster/ipfs-cluster#572](https://github.com/lubanproj/ipfs-cluster/issues/572) | [ipfs-cluster/ipfs-cluster#589](https://github.com/lubanproj/ipfs-cluster/issues/589) | [ipfs-cluster/ipfs-cluster#587](https://github.com/lubanproj/ipfs-cluster/issues/587)
  * Add a `docker-compose.yml` template, which creates a two peer cluster | [ipfs-cluster/ipfs-cluster#585](https://github.com/lubanproj/ipfs-cluster/issues/585) | [ipfs-cluster/ipfs-cluster#588](https://github.com/lubanproj/ipfs-cluster/issues/588)
  * Support overwriting configuration values in the `cluster` section with environmental values | [ipfs-cluster/ipfs-cluster#575](https://github.com/lubanproj/ipfs-cluster/issues/575) | [ipfs-cluster/ipfs-cluster#596](https://github.com/lubanproj/ipfs-cluster/issues/596)
  * Set snaps to `classic` confinement mode and revert it since approval never arrived | [ipfs-cluster/ipfs-cluster#579](https://github.com/lubanproj/ipfs-cluster/issues/579) | [ipfs-cluster/ipfs-cluster#594](https://github.com/lubanproj/ipfs-cluster/issues/594)
* Use Go's reverse proxy library in the proxy endpoint | [ipfs-cluster/ipfs-cluster#570](https://github.com/lubanproj/ipfs-cluster/issues/570) | [ipfs-cluster/ipfs-cluster#605](https://github.com/lubanproj/ipfs-cluster/issues/605)


##### Bug fixes

  * `/add` endpoints improvements and IPFS Companion compatibility | [ipfs-cluster/ipfs-cluster#582](https://github.com/lubanproj/ipfs-cluster/issues/582) | [ipfs-cluster/ipfs-cluster#569](https://github.com/lubanproj/ipfs-cluster/issues/569)
  * Fix adding with spaces in the name parameter | [ipfs-cluster/ipfs-cluster#583](https://github.com/lubanproj/ipfs-cluster/issues/583)
  * Escape filter query parameter | [ipfs-cluster/ipfs-cluster#586](https://github.com/lubanproj/ipfs-cluster/issues/586)
  * Fix some race conditions | [ipfs-cluster/ipfs-cluster#597](https://github.com/lubanproj/ipfs-cluster/issues/597)
  * Improve pin deserialization efficiency | [ipfs-cluster/ipfs-cluster#601](https://github.com/lubanproj/ipfs-cluster/issues/601)
  * Do not error remote pins | [ipfs-cluster/ipfs-cluster#600](https://github.com/lubanproj/ipfs-cluster/issues/600) | [ipfs-cluster/ipfs-cluster#603](https://github.com/lubanproj/ipfs-cluster/issues/603)
  * Clean up testing folders in `rest` and `rest/client` after tests | [ipfs-cluster/ipfs-cluster#607](https://github.com/lubanproj/ipfs-cluster/issues/607)
...
##### Features
  ...
  * Move commands to the `cmd/` folder | [ipfs-cluster/ipfs-cluster#485](https://github.com/lubanproj/ipfs-cluster/issues/485) | [ipfs-cluster/ipfs-cluster#521](https://github.com/lubanproj/ipfs-cluster/issues/521) | [ipfs-cluster/ipfs-cluster#556](https://github.com/lubanproj/ipfs-cluster/issues/556)
  * Dependency upgrades: `go-dot`, `go-libp2p`, `cid` | [ipfs-cluster/ipfs-cluster#533](https://github.com/lubanproj/ipfs-cluster/issues/533) | [ipfs-cluster/ipfs-cluster#537](https://github.com/lubanproj/ipfs-cluster/issues/537) | [ipfs-cluster/ipfs-cluster#535](https://github.com/lubanproj/ipfs-cluster/issues/535) | [ipfs-cluster/ipfs-cluster#544](https://github.com/lubanproj/ipfs-cluster/issues/544) | [ipfs-cluster/ipfs-cluster#561](https://github.com/lubanproj/ipfs-cluster/issues/561)
  * Build with go-1.11 | [ipfs-cluster/ipfs-cluster#558](https://github.com/lubanproj/ipfs-cluster/issues/558)
  * Peer names in `PinInfo` | [ipfs-cluster/ipfs-cluster#446](https://github.com/lubanproj/ipfs-cluster/issues/446) | [ipfs-cluster/ipfs-cluster#531](https://github.com/lubanproj/ipfs-cluster/issues/531)
  * Wrap API client in an interface | [ipfs-cluster/ipfs-cluster#447](https://github.com/lubanproj/ipfs-cluster/issues/447) | [ipfs-cluster/ipfs-cluster#523](https://github.com/lubanproj/ipfs-cluster/issues/523) | [ipfs-cluster/ipfs-cluster#564](https://github.com/lubanproj/ipfs-cluster/issues/564)
  * `Makefile`: add `prcheck` target and fix `make all` | [ipfs-cluster/ipfs-cluster#536](https://github.com/lubanproj/ipfs-cluster/issues/536) | [ipfs-cluster/ipfs-cluster#542](https://github.com/lubanproj/ipfs-cluster/issues/542) | [ipfs-cluster/ipfs-cluster#539](https://github.com/lubanproj/ipfs-cluster/issues/539)
  * Docker: speed up [re]builds | [ipfs-cluster/ipfs-cluster#529](https://github.com/lubanproj/ipfs-cluster/issues/529)
  * Re-enable keep-alives on servers | [ipfs-cluster/ipfs-cluster#548](https://github.com/lubanproj/ipfs-cluster/issues/548) | [ipfs-cluster/ipfs-cluster#560](https://github.com/lubanproj/ipfs-cluster/issues/560)

##### Bugfixes

  * Fix adding to cluster with unhealthy peers | [ipfs-cluster/ipfs-cluster#543](https://github.com/lubanproj/ipfs-cluster/issues/543) | [ipfs-cluster/ipfs-cluster#549](https://github.com/lubanproj/ipfs-cluster/issues/549)
  * Fix Snap builds and pushes: multiple architectures re-enabled | [ipfs-cluster/ipfs-cluster#520](https://github.com/lubanproj/ipfs-cluster/issues/520) | [ipfs-cluster/ipfs-cluster#554](https://github.com/lubanproj/ipfs-cluster/issues/554) | [ipfs-cluster/ipfs-cluster#557](https://github.com/lubanproj/ipfs-cluster/issues/557) | [ipfs-cluster/ipfs-cluster#562](https://github.com/lubanproj/ipfs-cluster/issues/562) | [ipfs-cluster/ipfs-cluster#565](https://github.com/lubanproj/ipfs-cluster/issues/565)
  * Docs: Typos in Readme and some improvements | [ipfs-cluster/ipfs-cluster#547](https://github.com/lubanproj/ipfs-cluster/issues/547) | [ipfs-cluster/ipfs-cluster#567](https://github.com/lubanproj/ipfs-cluster/issues/567)
  * Fix tests in `stateless` PinTracker | [ipfs-cluster/ipfs-cluster#552](https://github.com/lubanproj/ipfs-cluster/issues/552) | [ipfs-cluster/ipfs-cluster#563](https://github.com/lubanproj/ipfs-cluster/issues/563)
...
##### Features
  ...
  * Libp2p upgrades (up to v6) | [ipfs-cluster/ipfs-cluster#456](https://github.com/lubanproj/ipfs-cluster/issues/456) | [ipfs-cluster/ipfs-cluster#482](https://github.com/lubanproj/ipfs-cluster/issues/482)
  * Support `/dns` multiaddresses for `node_multiaddress` | [ipfs-cluster/ipfs-cluster#462](https://github.com/lubanproj/ipfs-cluster/issues/462) | [ipfs-cluster/ipfs-cluster#463](https://github.com/lubanproj/ipfs-cluster/issues/463)
  * Increase `state_sync_interval` to 10 minutes | [ipfs-cluster/ipfs-cluster#468](https://github.com/lubanproj/ipfs-cluster/issues/468) | [ipfs-cluster/ipfs-cluster#469](https://github.com/lubanproj/ipfs-cluster/issues/469)
  * Auto-interpret libp2p addresses in `rest/client`'s `APIAddr` configuration option | [ipfs-cluster/ipfs-cluster#498](https://github.com/lubanproj/ipfs-cluster/issues/498)
  * Resolve `APIAddr` (for `/dnsaddr` usage) in `rest/client` | [ipfs-cluster/ipfs-cluster#498](https://github.com/lubanproj/ipfs-cluster/issues/498)
  * Support for adding content to Cluster and sharding (sharding is disabled) | [ipfs-cluster/ipfs-cluster#484](https://github.com/lubanproj/ipfs-cluster/issues/484) | [ipfs-cluster/ipfs-cluster#503](https://github.com/lubanproj/ipfs-cluster/issues/503) | [ipfs-cluster/ipfs-cluster#495](https://github.com/lubanproj/ipfs-cluster/issues/495) | [ipfs-cluster/ipfs-cluster#504](https://github.com/lubanproj/ipfs-cluster/issues/504) | [ipfs-cluster/ipfs-cluster#509](https://github.com/lubanproj/ipfs-cluster/issues/509) | [ipfs-cluster/ipfs-cluster#511](https://github.com/lubanproj/ipfs-cluster/issues/511) | [ipfs-cluster/ipfs-cluster#518](https://github.com/lubanproj/ipfs-cluster/issues/518)
  * `stateless` PinTracker [ipfs-cluster/ipfs-cluster#308](https://github.com/lubanproj/ipfs-cluster/issues/308) | [ipfs-cluster/ipfs-cluster#460](https://github.com/lubanproj/ipfs-cluster/issues/460)
  * Add `size-only=true` to `repo/stat` calls | [ipfs-cluster/ipfs-cluster#507](https://github.com/lubanproj/ipfs-cluster/issues/507)
  * Enable DHT-based peer discovery and routing for cluster peers | [ipfs-cluster/ipfs-cluster#489](https://github.com/lubanproj/ipfs-cluster/issues/489) | [ipfs-cluster/ipfs-cluster#508](https://github.com/lubanproj/ipfs-cluster/issues/508)
  * Gx-go upgrade | [ipfs-cluster/ipfs-cluster#517](https://github.com/lubanproj/ipfs-cluster/issues/517)

##### Bugfixes

  * Fix type for constants | [ipfs-cluster/ipfs-cluster#455](https://github.com/lubanproj/ipfs-cluster/issues/455)
  * Gofmt fix | [ipfs-cluster/ipfs-cluster#464](https://github.com/lubanproj/ipfs-cluster/issues/464)
  * Fix tests for forked repositories | [ipfs-cluster/ipfs-cluster#465](https://github.com/lubanproj/ipfs-cluster/issues/465) | [ipfs-cluster/ipfs-cluster#472](https://github.com/lubanproj/ipfs-cluster/issues/472)
  * Fix resolve panic on `rest/client` | [ipfs-cluster/ipfs-cluster#498](https://github.com/lubanproj/ipfs-cluster/issues/498)
  * Fix remote pins stuck in error state | [ipfs-cluster/ipfs-cluster#500](https://github.com/lubanproj/ipfs-cluster/issues/500) | [ipfs-cluster/ipfs-cluster#460](https://github.com/lubanproj/ipfs-cluster/issues/460)
  * Fix running some tests with `-race` | [ipfs-cluster/ipfs-cluster#340](https://github.com/lubanproj/ipfs-cluster/issues/340) | [ipfs-cluster/ipfs-cluster#458](https://github.com/lubanproj/ipfs-cluster/issues/458)
  * Fix ipfs proxy `/add` endpoint | [ipfs-cluster/ipfs-cluster#495](https://github.com/lubanproj/ipfs-cluster/issues/495) | [ipfs-cluster/ipfs-cluster#81](https://github.com/lubanproj/ipfs-cluster/issues/81) | [ipfs-cluster/ipfs-cluster#505](https://github.com/lubanproj/ipfs-cluster/issues/505)
  * Fix ipfs proxy not hijacking `repo/stat` | [ipfs-cluster/ipfs-cluster#466](https://github.com/lubanproj/ipfs-cluster/issues/466) | [ipfs-cluster/ipfs-cluster#514](https://github.com/lubanproj/ipfs-cluster/issues/514)
  * Fix some godoc comments | [ipfs-cluster/ipfs-cluster#519](https://github.com/lubanproj/ipfs-cluster/issues/519)
...
##### Features
  ...
  * Consensus refactorings | [ipfs-cluster/ipfs-cluster#398](https://github.com/lubanproj/ipfs-cluster/issues/398) | [ipfs-cluster/ipfs-cluster#371](https://github.com/lubanproj/ipfs-cluster/issues/371)
  * Pintracker revamp | [ipfs-cluster/ipfs-cluster#308](https://github.com/lubanproj/ipfs-cluster/issues/308) | [ipfs-cluster/ipfs-cluster#383](https://github.com/lubanproj/ipfs-cluster/issues/383) | [ipfs-cluster/ipfs-cluster#408](https://github.com/lubanproj/ipfs-cluster/issues/408) | [ipfs-cluster/ipfs-cluster#415](https://github.com/lubanproj/ipfs-cluster/issues/415) | [ipfs-cluster/ipfs-cluster#421](https://github.com/lubanproj/ipfs-cluster/issues/421) | [ipfs-cluster/ipfs-cluster#427](https://github.com/lubanproj/ipfs-cluster/issues/427) | [ipfs-cluster/ipfs-cluster#432](https://github.com/lubanproj/ipfs-cluster/issues/432)
  * Pubsub monitoring | [ipfs-cluster/ipfs-cluster#400](https://github.com/lubanproj/ipfs-cluster/issues/400)
  * Force killing cluster with double CTRL-C | [ipfs-cluster/ipfs-cluster#258](https://github.com/lubanproj/ipfs-cluster/issues/258) | [ipfs-cluster/ipfs-cluster#358](https://github.com/lubanproj/ipfs-cluster/issues/358)
  * 3x faster testsuite | [ipfs-cluster/ipfs-cluster#339](https://github.com/lubanproj/ipfs-cluster/issues/339) | [ipfs-cluster/ipfs-cluster#350](https://github.com/lubanproj/ipfs-cluster/issues/350)
  * Introduce `disable_repinning` option | [ipfs-cluster/ipfs-cluster#369](https://github.com/lubanproj/ipfs-cluster/issues/369) | [ipfs-cluster/ipfs-cluster#387](https://github.com/lubanproj/ipfs-cluster/issues/387)
  * Documentation moved to website and fixes | [ipfs-cluster/ipfs-cluster#390](https://github.com/lubanproj/ipfs-cluster/issues/390) | [ipfs-cluster/ipfs-cluster#391](https://github.com/lubanproj/ipfs-cluster/issues/391) | [ipfs-cluster/ipfs-cluster#393](https://github.com/lubanproj/ipfs-cluster/issues/393) | [ipfs-cluster/ipfs-cluster#347](https://github.com/lubanproj/ipfs-cluster/issues/347)
  * Run Docker container with `daemon --upgrade` by default | [ipfs-cluster/ipfs-cluster#394](https://github.com/lubanproj/ipfs-cluster/issues/394)
  * Remove the `ipfs-cluster-ctl peers add` command (bootstrap should be used to add peers) | [ipfs-cluster/ipfs-cluster#397](https://github.com/lubanproj/ipfs-cluster/issues/397)
  * Add tests using HTTPs endpoints | [ipfs-cluster/ipfs-cluster#191](https://github.com/lubanproj/ipfs-cluster/issues/191) | [ipfs-cluster/ipfs-cluster#403](https://github.com/lubanproj/ipfs-cluster/issues/403)
  * Set `refs` as default `pinning_method` and `10` as default `concurrent_pins` | [ipfs-cluster/ipfs-cluster#420](https://github.com/lubanproj/ipfs-cluster/issues/420)
  * Use latest `gx` and `gx-go`. Be more verbose when installing | [ipfs-cluster/ipfs-cluster#418](https://github.com/lubanproj/ipfs-cluster/issues/418)
  * Makefile: Properly retrigger builds on source change | [ipfs-cluster/ipfs-cluster#426](https://github.com/lubanproj/ipfs-cluster/issues/426)
  * Improvements to StateSync() | [ipfs-cluster/ipfs-cluster#429](https://github.com/lubanproj/ipfs-cluster/issues/429)
  * Rename `ipfs-cluster-data` folder to `raft` | [ipfs-cluster/ipfs-cluster#430](https://github.com/lubanproj/ipfs-cluster/issues/430)
  * Officially support go 1.10 | [ipfs-cluster/ipfs-cluster#439](https://github.com/lubanproj/ipfs-cluster/issues/439)
  * Update to libp2p 5.0.17 | [ipfs-cluster/ipfs-cluster#440](https://github.com/lubanproj/ipfs-cluster/issues/440)

##### Bugsfixes:

  * Don't keep peers /ip*/ addresses if we know DNS addresses for them | [ipfs-cluster/ipfs-cluster#381](https://github.com/lubanproj/ipfs-cluster/issues/381)
  * Running cluster with wrong configuration path gives misleading error | [ipfs-cluster/ipfs-cluster#343](https://github.com/lubanproj/ipfs-cluster/issues/343) | [ipfs-cluster/ipfs-cluster#370](https://github.com/lubanproj/ipfs-cluster/issues/370) | [ipfs-cluster/ipfs-cluster#373](https://github.com/lubanproj/ipfs-cluster/issues/373)
  * Do not fail when running with `daemon --upgrade` and no state is present | [ipfs-cluster/ipfs-cluster#395](https://github.com/lubanproj/ipfs-cluster/issues/395)
  * IPFS Proxy: handle arguments passed as part of the url | [ipfs-cluster/ipfs-cluster#380](https://github.com/lubanproj/ipfs-cluster/issues/380) | [ipfs-cluster/ipfs-cluster#392](https://github.com/lubanproj/ipfs-cluster/issues/392)
  * WaitForUpdates() may return before state is fully synced | [ipfs-cluster/ipfs-cluster#378](https://github.com/lubanproj/ipfs-cluster/issues/378)
  * Configuration mutates no more and shadowing is no longer necessary | [ipfs-cluster/ipfs-cluster#235](https://github.com/lubanproj/ipfs-cluster/issues/235)
  * Govet fixes | [ipfs-cluster/ipfs-cluster#417](https://github.com/lubanproj/ipfs-cluster/issues/417)
  * Fix release changelog when having RC tags
  * Fix lock file not being removed on cluster force-kill | [ipfs-cluster/ipfs-cluster#423](https://github.com/lubanproj/ipfs-cluster/issues/423) | [ipfs-cluster/ipfs-cluster#437](https://github.com/lubanproj/ipfs-cluster/issues/437)
  * Fix indirect pins not being correctly parsed | [ipfs-cluster/ipfs-cluster#428](https://github.com/lubanproj/ipfs-cluster/issues/428) | [ipfs-cluster/ipfs-cluster#436](https://github.com/lubanproj/ipfs-cluster/issues/436)
  * Enable NAT support in libp2p host | [ipfs-cluster/ipfs-cluster#346](https://github.com/lubanproj/ipfs-cluster/issues/346) | [ipfs-cluster/ipfs-cluster#441](https://github.com/lubanproj/ipfs-cluster/issues/441)
  * Fix pubsub monitor not working on ARM | [ipfs-cluster/ipfs-cluster#433](https://github.com/lubanproj/ipfs-cluster/issues/433) | [ipfs-cluster/ipfs-cluster#443](https://github.com/lubanproj/ipfs-cluster/issues/443)
...
* Features
  * `--no-status` for `ipfs-cluster-ctl pin add/rm` allows to speed up adding and removing by not fetching the status one second afterwards. Useful for ingesting pinsets to cluster | [ipfs-cluster/ipfs-cluster#286](https://github.com/lubanproj/ipfs-cluster/issues/286) | [ipfs-cluster/ipfs-cluster#329](https://github.com/lubanproj/ipfs-cluster/issues/329)
  * `--wait` flag for `ipfs-cluster-ctl pin add/rm` allows to wait until a CID is fully pinned or unpinned [ipfs-cluster/ipfs-cluster#338](https://github.com/lubanproj/ipfs-cluster/issues/338) | [ipfs-cluster/ipfs-cluster#348](https://github.com/lubanproj/ipfs-cluster/issues/348) | [ipfs-cluster/ipfs-cluster#363](https://github.com/lubanproj/ipfs-cluster/issues/363)
  * Support `refs` pinning method. Parallel pinning | [ipfs-cluster/ipfs-cluster#326](https://github.com/lubanproj/ipfs-cluster/issues/326) | [ipfs-cluster/ipfs-cluster#331](https://github.com/lubanproj/ipfs-cluster/issues/331)
  * Double default timeouts for `ipfs-cluster-ctl` | [ipfs-cluster/ipfs-cluster#323](https://github.com/lubanproj/ipfs-cluster/issues/323) | [ipfs-cluster/ipfs-cluster#334](https://github.com/lubanproj/ipfs-cluster/issues/334)
  * Better error messages during startup | [ipfs-cluster/ipfs-cluster#167](https://github.com/lubanproj/ipfs-cluster/issues/167) | [ipfs-cluster/ipfs-cluster#344](https://github.com/lubanproj/ipfs-cluster/issues/344) | [ipfs-cluster/ipfs-cluster#353](https://github.com/lubanproj/ipfs-cluster/issues/353)
  * REST API client now provides an `IPFS()` method which returns a `go-ipfs-api` shell instance pointing to the proxy endpoint | [ipfs-cluster/ipfs-cluster#269](https://github.com/lubanproj/ipfs-cluster/issues/269) | [ipfs-cluster/ipfs-cluster#356](https://github.com/lubanproj/ipfs-cluster/issues/356)
  * REST http-api-over-libp2p. Server, client, `ipfs-cluster-ctl` support added | [ipfs-cluster/ipfs-cluster#305](https://github.com/lubanproj/ipfs-cluster/issues/305) | [ipfs-cluster/ipfs-cluster#349](https://github.com/lubanproj/ipfs-cluster/issues/349)
  * Added support for priority pins and non-recursive pins (sharding-related) | [ipfs-cluster/ipfs-cluster#341](https://github.com/lubanproj/ipfs-cluster/issues/341) | [ipfs-cluster/ipfs-cluster#342](https://github.com/lubanproj/ipfs-cluster/issues/342)
  * Documentation fixes | [ipfs-cluster/ipfs-cluster#328](https://github.com/lubanproj/ipfs-cluster/issues/328) | [ipfs-cluster/ipfs-cluster#357](https://github.com/lubanproj/ipfs-cluster/issues/357)

* Bugfixes
  * Print lock path in logs | [ipfs-cluster/ipfs-cluster#332](https://github.com/lubanproj/ipfs-cluster/issues/332) | [ipfs-cluster/ipfs-cluster#333](https://github.com/lubanproj/ipfs-cluster/issues/333)
...
* Bugfixes
  * Pre-built binaries panic on start | [ipfs-cluster/ipfs-cluster#320](https://github.com/lubanproj/ipfs-cluster/issues/320)
...
* Features
  * `ipfs-cluster-service daemon --upgrade` allows to automatically run migrations before starting | [ipfs-cluster/ipfs-cluster#300](https://github.com/lubanproj/ipfs-cluster/issues/300) | [ipfs-cluster/ipfs-cluster#307](https://github.com/lubanproj/ipfs-cluster/issues/307)
  * `ipfs-cluster-service state version` reports the shared state format version | [ipfs-cluster/ipfs-cluster#298](https://github.com/lubanproj/ipfs-cluster/issues/298) | [ipfs-cluster/ipfs-cluster#307](https://github.com/lubanproj/ipfs-cluster/issues/307)
  * `ipfs-cluster-service health graph` generates a .dot graph file of cluster connectivity | [ipfs-cluster/ipfs-cluster#17](https://github.com/lubanproj/ipfs-cluster/issues/17) | [ipfs-cluster/ipfs-cluster#291](https://github.com/lubanproj/ipfs-cluster/issues/291) | [ipfs-cluster/ipfs-cluster#311](https://github.com/lubanproj/ipfs-cluster/issues/311)

* Bugfixes
  * Do not upgrade state if already up to date | [ipfs-cluster/ipfs-cluster#296](https://github.com/lubanproj/ipfs-cluster/issues/296) | [ipfs-cluster/ipfs-cluster#307](https://github.com/lubanproj/ipfs-cluster/issues/307)
  * Fix `ipfs-cluster-service daemon` failing with `unknown allocation strategy` error | [ipfs-cluster/ipfs-cluster#314](https://github.com/lubanproj/ipfs-cluster/issues/314) | [ipfs-cluster/ipfs-cluster#315](https://github.com/lubanproj/ipfs-cluster/issues/315)
...
* Features
  * New `ipfs-cluster-service state export/import/cleanup` commands | [ipfs-cluster/ipfs-cluster#240](https://github.com/lubanproj/ipfs-cluster/issues/240) | [ipfs-cluster/ipfs-cluster#290](https://github.com/lubanproj/ipfs-cluster/issues/290)
  * New min/max replication factor control | [ipfs-cluster/ipfs-cluster#277](https://github.com/lubanproj/ipfs-cluster/issues/277) | [ipfs-cluster/ipfs-cluster#292](https://github.com/lubanproj/ipfs-cluster/issues/292)
  * Improved migration code | [ipfs-cluster/ipfs-cluster#283](https://github.com/lubanproj/ipfs-cluster/issues/283)
  * `ipfs-cluster-service version` output simplified (see below) | [ipfs-cluster/ipfs-cluster#274](https://github.com/lubanproj/ipfs-cluster/issues/274)
  * Testing improvements:
    * Added tests for Dockerfiles | [ipfs-cluster/ipfs-cluster#200](https://github.com/lubanproj/ipfs-cluster/issues/200) | [ipfs-cluster/ipfs-cluster#282](https://github.com/lubanproj/ipfs-cluster/issues/282)
    * Enabled Jenkins testing and made it work | [ipfs-cluster/ipfs-cluster#256](https://github.com/lubanproj/ipfs-cluster/issues/256) | [ipfs-cluster/ipfs-cluster#294](https://github.com/lubanproj/ipfs-cluster/issues/294)
  * Documentation improvements:
    * Guide contains more details on state upgrade procedures | [ipfs-cluster/ipfs-cluster#270](https://github.com/lubanproj/ipfs-cluster/issues/270)
    * ipfs-cluster-ctl exit status are documented on the README | [ipfs-cluster/ipfs-cluster#178](https://github.com/lubanproj/ipfs-cluster/issues/178)

* Bugfixes
  * Force cleanup after sharness tests | [ipfs-cluster/ipfs-cluster#181](https://github.com/lubanproj/ipfs-cluster/issues/181) | [ipfs-cluster/ipfs-cluster#288](https://github.com/lubanproj/ipfs-cluster/issues/288)
  * Fix state version validation on start | [ipfs-cluster/ipfs-cluster#293](https://github.com/lubanproj/ipfs-cluster/issues/293)
  * Wait until last index is applied before attempting snapshot on shutdown | [ipfs-cluster/ipfs-cluster#275](https://github.com/lubanproj/ipfs-cluster/issues/275)
  * Snaps from master not pushed due to bad credentials
  * Fix overpinning or underpinning of CIDs after re-join | [ipfs-cluster/ipfs-cluster#222](https://github.com/lubanproj/ipfs-cluster/issues/222)
  * Fix unmarshaling state on top of an existing one | [ipfs-cluster/ipfs-cluster#297](https://github.com/lubanproj/ipfs-cluster/issues/297)
  * Fix catching up on imported state | [ipfs-cluster/ipfs-cluster#297](https://github.com/lubanproj/ipfs-cluster/issues/297)
...
* Features
 * `ipfs-cluster-service state upgrade` | [ipfs-cluster/ipfs-cluster#194](https://github.com/lubanproj/ipfs-cluster/issues/194)
 * `ipfs-cluster-test` Docker image runs with `ipfs:master` | [ipfs-cluster/ipfs-cluster#155](https://github.com/lubanproj/ipfs-cluster/issues/155) | [ipfs-cluster/ipfs-cluster#259](https://github.com/lubanproj/ipfs-cluster/issues/259)
 * `ipfs-cluster` Docker image only runs `ipfs-cluster-service` (and not the ipfs daemon anymore) | [ipfs-cluster/ipfs-cluster#197](https://github.com/lubanproj/ipfs-cluster/issues/197) | [ipfs-cluster/ipfs-cluster#155](https://github.com/lubanproj/ipfs-cluster/issues/155) | [ipfs-cluster/ipfs-cluster#259](https://github.com/lubanproj/ipfs-cluster/issues/259)
 * Support for DNS multiaddresses for cluster peers | [ipfs-cluster/ipfs-cluster#155](https://github.com/lubanproj/ipfs-cluster/issues/155) | [ipfs-cluster/ipfs-cluster#259](https://github.com/lubanproj/ipfs-cluster/issues/259)
 * Add configuration section and options for `pin_tracker` | [ipfs-cluster/ipfs-cluster#155](https://github.com/lubanproj/ipfs-cluster/issues/155) | [ipfs-cluster/ipfs-cluster#259](https://github.com/lubanproj/ipfs-cluster/issues/259)
 * Add `local` flag to Status, Sync, Recover endpoints which allows to run this operations only in the peer receiving the request | [ipfs-cluster/ipfs-cluster#155](https://github.com/lubanproj/ipfs-cluster/issues/155) | [ipfs-cluster/ipfs-cluster#259](https://github.com/lubanproj/ipfs-cluster/issues/259)
 * Add Pin names | [ipfs-cluster/ipfs-cluster#249](https://github.com/lubanproj/ipfs-cluster/issues/249)
 * Add Peer names | [ipfs-cluster/ipfs-cluster#250](https://github.com/lubanproj/ipfs-cluster/issues/250)
 * New REST API Client module `github.com/lubanproj/ipfs-cluster/api/rest/client` allows to integrate against cluster | [ipfs-cluster/ipfs-cluster#260](https://github.com/lubanproj/ipfs-cluster/issues/260) | [ipfs-cluster/ipfs-cluster#263](https://github.com/lubanproj/ipfs-cluster/issues/263) | [ipfs-cluster/ipfs-cluster#266](https://github.com/lubanproj/ipfs-cluster/issues/266)
 * A few rounds addressing code quality issues | [ipfs-cluster/ipfs-cluster#264](https://github.com/lubanproj/ipfs-cluster/issues/264)
...
* Features
  * Upgrade Raft to 1.0.0 | [ipfs-cluster/ipfs-cluster#194](https://github.com/lubanproj/ipfs-cluster/issues/194) | [ipfs-cluster/ipfs-cluster#196](https://github.com/lubanproj/ipfs-cluster/issues/196)
  * Support Snaps | [ipfs-cluster/ipfs-cluster#234](https://github.com/lubanproj/ipfs-cluster/issues/234) | [ipfs-cluster/ipfs-cluster#228](https://github.com/lubanproj/ipfs-cluster/issues/228) | [ipfs-cluster/ipfs-cluster#232](https://github.com/lubanproj/ipfs-cluster/issues/232)
  * Rotating backups for ipfs-cluster-data | [ipfs-cluster/ipfs-cluster#233](https://github.com/lubanproj/ipfs-cluster/issues/233)
  * Bring documentation up to date with the code [ipfs-cluster/ipfs-cluster#223](https://github.com/lubanproj/ipfs-cluster/issues/223)

Bugfixes:
  * Fix docker startup | [ipfs-cluster/ipfs-cluster#216](https://github.com/lubanproj/ipfs-cluster/issues/216) | [ipfs-cluster/ipfs-cluster#217](https://github.com/lubanproj/ipfs-cluster/issues/217)
  * Fix configuration save | [ipfs-cluster/ipfs-cluster#213](https://github.com/lubanproj/ipfs-cluster/issues/213) | [ipfs-cluster/ipfs-cluster#214](https://github.com/lubanproj/ipfs-cluster/issues/214)
  * Forward progress updates with IPFS-Proxy | [ipfs-cluster/ipfs-cluster#224](https://github.com/lubanproj/ipfs-cluster/issues/224) | [ipfs-cluster/ipfs-cluster#231](https://github.com/lubanproj/ipfs-cluster/issues/231)
  * Delay ipfs connect swarms on boot and safeguard against panic condition | [ipfs-cluster/ipfs-cluster#238](https://github.com/lubanproj/ipfs-cluster/issues/238)
  * Multiple minor fixes | [ipfs-cluster/ipfs-cluster#236](https://github.com/lubanproj/ipfs-cluster/issues/236)
...
* Note that `--bootstrap` and `--leave` flags when calling `ipfs-cluster-service` will be stored permanently in the configuration (see [ipfs-cluster/ipfs-cluster#235](https://github.com/lubanproj/ipfs-cluster/issues/235)).
...
* Fixes:
  * Dockerfile runs `ipfs-cluster-service` instead of `ctl` | [ipfs-cluster/ipfs-cluster#194](https://github.com/lubanproj/ipfs-cluster/issues/194) | [ipfs-cluster/ipfs-cluster#196](https://github.com/lubanproj/ipfs-cluster/issues/196)
  * Peers and bootstrap entries in the configuration are ignored | [ipfs-cluster/ipfs-cluster#203](https://github.com/lubanproj/ipfs-cluster/issues/203) | [ipfs-cluster/ipfs-cluster#204](https://github.com/lubanproj/ipfs-cluster/issues/204)
  * Informers do not work on 32-bit architectures | [ipfs-cluster/ipfs-cluster#202](https://github.com/lubanproj/ipfs-cluster/issues/202) | [ipfs-cluster/ipfs-cluster#205](https://github.com/lubanproj/ipfs-cluster/issues/205)
  * Replication factor entry in the configuration is ignored | [ipfs-cluster/ipfs-cluster#208](https://github.com/lubanproj/ipfs-cluster/issues/208) | [ipfs-cluster/ipfs-cluster#209](https://github.com/lubanproj/ipfs-cluster/issues/209)
...
* Features:
  * Basic authentication support added to API component | [ipfs-cluster/ipfs-cluster#121](https://github.com/lubanproj/ipfs-cluster/issues/121) | [ipfs-cluster/ipfs-cluster#147](https://github.com/lubanproj/ipfs-cluster/issues/147) | [ipfs-cluster/ipfs-cluster#179](https://github.com/lubanproj/ipfs-cluster/issues/179)
  * Copy peers to bootstrap when leaving a cluster | [ipfs-cluster/ipfs-cluster#170](https://github.com/lubanproj/ipfs-cluster/issues/170) | [ipfs-cluster/ipfs-cluster#112](https://github.com/lubanproj/ipfs-cluster/issues/112)
  * New configuration format | [ipfs-cluster/ipfs-cluster#162](https://github.com/lubanproj/ipfs-cluster/issues/162) | [ipfs-cluster/ipfs-cluster#177](https://github.com/lubanproj/ipfs-cluster/issues/177)
  * Freespace disk metric implementation. It's now the default. | [ipfs-cluster/ipfs-cluster#142](https://github.com/lubanproj/ipfs-cluster/issues/142) | [ipfs-cluster/ipfs-cluster#99](https://github.com/lubanproj/ipfs-cluster/issues/99)

* Fixes:
  * IPFS Connector should use only POST | [ipfs-cluster/ipfs-cluster#176](https://github.com/lubanproj/ipfs-cluster/issues/176) | [ipfs-cluster/ipfs-cluster#161](https://github.com/lubanproj/ipfs-cluster/issues/161)
  * `ipfs-cluster-ctl` exit status with error responses | [ipfs-cluster/ipfs-cluster#174](https://github.com/lubanproj/ipfs-cluster/issues/174)
  * Sharness tests and update testing container | [ipfs-cluster/ipfs-cluster#171](https://github.com/lubanproj/ipfs-cluster/issues/171)
  * Update Dockerfiles | [ipfs-cluster/ipfs-cluster#154](https://github.com/lubanproj/ipfs-cluster/issues/154) | [ipfs-cluster/ipfs-cluster#185](https://github.com/lubanproj/ipfs-cluster/issues/185)
  * `ipfs-cluster-service`: Do not run service with unknown subcommands | [ipfs-cluster/ipfs-cluster#186](https://github.com/lubanproj/ipfs-cluster/issues/186)
